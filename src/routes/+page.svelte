<script lang="ts">
        ...
        onMount(() => {
                ...
                Promise.all(Object.values(imageModules).map((loader) => loader())).then(
                        (images) => {
        ...
        // Returns cleanup function to prevent memory leak
        $effect(() => {
        ...
        <section class="hero">
                ...
                {#if galleryImages.length > 1}
                        ...
                        <div class="carousel-indicators">
                                {#each Array(galleryImages.length) as _, index (index)}
                                        <button
                                                class="indicator"
                                                class:active={index === currentImageIndex}
